...
Route::get('/tests', function () {
    return view('about_us.test');
});

Route::get('/contact_us', function () {
    return view('home.landing.contact_us');
});
Route::post('/contact_us', [ContactController::class,'addContactData']);
...
Route::get('/teaching_positions', function () {
    return view('/../about_us/teaching_positions');
});

Route::get('/internship_positions', function () {
    return view('/../about_us/internship_positions');
});

Route::get('/masti_crew', function () {
    return view('/../about_us/masti_crew');
});
...
Route::get('/corporate_entertainment',[ImageController::class,'corporateEntertainment']);

Route::get('/hire_faq
', function () {
    return view('/../hire_us/faq');
})->name('hire-faq');

// Route::get('/school_workshops
// ', function () {
//     return view('/../hire_us/school_workshops');
// });

Route::get('/school_workshops',[ImageController::class,'schoolWorkshops']);
...
Route::get('/team_building_activities
', function () {
    return view('/../hire_us/team_building_activities');
});

Route::get('/flashmobs
', function () {
    return view('/../hire_us/flashmobs');
});

Route::get('/policies
', function () {
    return view('/../classes/policies');
});
...
Route::get('/online
', function () {
    return view('/../classes/online');
});
Route::get('/plano
', function () {
    return view('/../classes/plano');
});
Route::get('/west_frisco
', function () {
    return view('/../classes/west_frisco');
});
Route::get('/coppell
', function () {
    return view('/../classes/coppell');
});
Route::get('/private_gully
', function () {
    return view('/../classes/private_gully');
});
Route::get('/tuition
', function () {
...
Route::get('/classes_faq
', function () {
    return view('/../classes/faq');
});
...
Route::get('/indowestern',[ImageController::class,'indowestern']);
Route::get('/indowestern/age_4_8',[ImageController::class,'indowesternAge8']);
...
Route::any("/admin/costume", 'CostumeController@costume');
...
Route::any("/admin/costume", 'CostumeController@costume');
Route::any("/admin/get_costume_picture", 'CostumeController@costume_picture');
...
<body onload="myFunction()">
   <div style="display:none;" id="myDiv" class="animate-bottom">
      ...
      <style type="text/css">#loading1{opacity: 1;}
   </style>
<!-- <div class="section section-boxes section-noflow shading-full margin-normal section-auto shading-layers shading-highlight shading-opacity-50 colors-highlight shading-background-img shading-position-cover bg-1001" id="test">
                     ...
                     <div class="boxes-buffer">
                        <div class="boxes-holder shading-holder shading-holder-box">
                           <div class="header-group n bc">
                              <h3 class="g b">GET <b>IN TOUCH</b> WITH US</h3>
                           </div>
...
<input type="submit" id="gform_submit_button_2" class="gform_button button" value="Reach Us" />
</div>
                                 </form>
                              </div>
